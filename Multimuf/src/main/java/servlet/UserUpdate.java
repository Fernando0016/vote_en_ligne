...
public class UserUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            User newUser = new User(mail, pseudo, pass);
            String email = request.getAttribute("mail").toString();
            User update = user.update(email, newUser);
            request.setAttribute("modif_success","modification SUCCESS");
        } catch (Exception e) {
            request.setAttribute("info", e);
        }
        // apres il faut faire un pop up
        request.getRequestDispatcher("jsp/modification.jsp").forward(request, response);
